...
import com.myself.sbdiancan.utils.JsonUtil;
import com.myself.sbdiancan.utils.MathUtil;
 ...
 * @QQ:1341933031
 * @Date:Created in 9:57 2018\6\4 0004
 */
@Service
@Slf4j
public class PayServiceImpl implements PayService {
    ...
    public PayResponse notify(String notifyData) {
        ...
        if (!MathUtil.equals(payResponse.getOrderAmount(),orderDTO.getOrderAmount().doubleValue())){
            ...
            throw new SbException(ResultEnum.WXPAY_NOTIFY_MONEY_VERIFY_ERROR);
        }
